...
class Test_remove_product_to_cart_from_detail_page:
    def test_remove_product_to_cart_from_detail_page_1(self):
        ...
        print("✅ Cart badge correctly shows 1 item in details page.")
        ...
        print("✅ Cart badge correctly shows 0 item in details page.")